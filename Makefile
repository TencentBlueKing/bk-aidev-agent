...
release_ai_blueking:
	...
	sed -i 's/"@blueking\/ai-blueking": "[^"]*"/"@blueking\/ai-blueking": "'"$$VERSION"'"/' ${ROOT_DIR}/src/frontend/publish-template/package.json; \
	...
	echo "  - src/frontend/publish-template/package.json"; \
