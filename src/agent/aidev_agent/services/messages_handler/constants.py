...
class EnvVarNames:
    ...
    REDIS_WAITAOF_ENABLED = "MSG_REDIS_WAITAOF_ENABLED"
    REDIS_WAITAOF_LOCAL = "MSG_REDIS_WAITAOF_LOCAL"
    REDIS_WAITAOF_REPLICAS = "MSG_REDIS_WAITAOF_REPLICAS"
    REDIS_WAITAOF_TIMEOUT_MS = "MSG_REDIS_WAITAOF_TIMEOUT_MS"
