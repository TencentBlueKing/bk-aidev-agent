...
# 在测试环境中强制使用requests以便responses库可以拦截
os.environ["FORCE_REQUESTS"] = "true"
...
class TestSSMClient:
    ...
    def setup_method(self):
        ...
        self.client = SSMClient(
            ...
            http_client="requests",  # 强制使用requests以便测试
        )
    ...
    def test_init(self):
        ...
        assert self.client.http_client == "requests"
...
class TestSSMApi:
    ...
    def test_get_user_client(self):
        ...
        with patch("aidev_agent.api.bk_ssm.SSMClient") as mock_client_class:
            ...
            client = SSMApi.get_user_client("test_user", "test_bk_token")
...
class TestSSMIntegration:
    ...
    def test_complete_workflow(self):
        ...
        client = SSMClient(
            ...
            http_client="requests",  # 强制使用requests以便responses拦截
        )
